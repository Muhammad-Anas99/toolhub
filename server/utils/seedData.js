...
export const toolSeed = [
  ...
  { name: 'Percentage Calculator', slug: 'percentage-calculator', path: '/tools/percentage-calculator', category: 'developer-tools', description: 'Calculate percentages, percentage of a number, and percentage change.', icon: 'FaPercent', badge: 'new', comingSoon: false },
  { name: 'Compound Interest Calculator', slug: 'compound-interest-calculator', path: '/tools/compound-interest-calculator', category: 'developer-tools', description: 'Calculate compound interest and final investment value over time.', icon: 'FaChartLine', badge: 'new', comingSoon: false },
  { name: 'Loan & Mortgage Calculator', slug: 'loan-calculator', path: '/tools/loan-calculator', category: 'developer-tools', description: 'Calculate monthly loan or mortgage payments, total paid, and total interest.', icon: 'FaHouseChimney', badge: 'new', comingSoon: false },
  { name: 'Profit Margin Calculator', slug: 'profit-margin-calculator', path: '/tools/profit-margin-calculator', category: 'developer-tools', description: 'Calculate profit margin and markup percentage from revenue and cost.', icon: 'FaCoins', badge: 'new', comingSoon: false },
  { name: 'Age Calculator', slug: 'age-calculator', path: '/tools/age-calculator', category: 'developer-tools', description: 'Calculate exact age in years, months, and days between two dates.', icon: 'FaCakeCandles', badge: 'new', comingSoon: false },
  ...
  { name: 'Random Name Picker', slug: 'random-name-picker', path: '/tools/random-name-picker', category: 'developer-tools', description: 'Pick a random name from a list.', icon: 'FaUserGroup', badge: 'new', comingSoon: false },
  { name: 'Random Word Generator', slug: 'random-word-generator', path: '/tools/random-word-generator', category: 'developer-tools', description: 'Generate one or more random words.', icon: 'FaFont', badge: 'new', comingSoon: false },
  { name: 'Random Number Generator', slug: 'random-number-generator', path: '/tools/random-number-generator', category: 'developer-tools', description: 'Generate a random number within a custom range.', icon: 'FaHashtag', badge: 'new', comingSoon: false },
  { name: 'Coin Flipper', slug: 'coin-flipper', path: '/tools/coin-flipper', category: 'developer-tools', description: 'Flip a virtual coin for a random heads or tails result.', icon: 'FaCircleDot', badge: 'new', comingSoon: false },
  { name: 'Dice Roller', slug: 'dice-roller', path: '/tools/dice-roller', category: 'developer-tools', description: 'Roll one or more virtual six-sided dice.', icon: 'FaDice', badge: 'new', comingSoon: false },
  { name: 'Choice Wheel Spinner', slug: 'choice-wheel-spinner', path: '/tools/choice-wheel-spinner', category: 'developer-tools', description: 'Spin a wheel to randomly pick from a custom list of options.', icon: 'FaCirclePlay', badge: 'new', comingSoon: false },
  ...
  { name: 'What Is My IP Address', slug: 'my-ip-address', path: '/tools/my-ip-address', category: 'security-tools', description: 'Find out your public IP address.', icon: 'FaGlobe', badge: 'new', comingSoon: false },
