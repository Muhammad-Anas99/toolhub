...
export default function Base64Tool({ toolSlug, toolName, category }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div>
        <label htmlFor="base64-input" className="text-sm font-medium text-slate-700 dark:text-slate-300">
        ...
        <textarea
          ...
          placeholder={mode === 'encode' ? 'Type or paste text...' : 'Paste Base64 text...'}
          spellCheck={false}
