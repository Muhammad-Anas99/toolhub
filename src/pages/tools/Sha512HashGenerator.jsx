...
export default function Sha512HashGenerator() {
  return <ToolLayout tool={tool} faqItems={toolFaqs[tool.slug]}><SingleHashGeneratorTool toolSlug={tool.slug} toolName={tool.name} category={tool.category} algorithm="SHA-512" /></ToolLayout>
}
